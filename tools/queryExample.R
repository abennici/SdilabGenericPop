...
query$box.z="year"
query$box.title="box"
query$data.title="table"
query$panel="line+pie+box+data"

query
#FAOCommodity
#?geoCol=flag&withFlag=TRUE&line.x=year&line.y=value&line.z=commodity&line.title=test&pie.x=commodity&pie.y=value&pie.z=year&pie.title=test&box.x=commodity&box.y=value&box.z=year&box.title=test&data.title=table&panel=line+pie+box+data&pid=fao_commodity_dbquery_adv&layer=fao_commodities_dbquery_adv_layer&csw_server=https://geonetwork-sdi-lab.d4science.org/geonetwork/srv/eng/csw&csw_version=2.0.2&wfs_server=https://geoserver-sdi-lab.d4science.org/geoserver/sdilab_fisheriesatlas/ows&wfs_version=1.0.0&feature_geom=false&strategy=ogc_viewparams&par=trade_flow:E;aggregation_method:sum&srs=EPSG:4326
#FAOCapture
