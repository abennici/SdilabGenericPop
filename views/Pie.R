#' @title Pie Module
#' @description 
#' This module create a tab inside 'Sdilab Generic Pop' app including a dynamic pie chart.
...
#' @param query$pie.x optional url parameter, select the default column to attribute. Must be an exact column name of data. If NULL the first column name of data is choosed.   
#' @param query$pie.y optional url parameter, select the default column to value. Must be an exact column name of data. If NULL the first column name of data is choosed.
#' @param query$pie.z optional url parameter, select the default column to display as time period. Must be an exact column name of data. If NULL the first column name of data is choosed.
